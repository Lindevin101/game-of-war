class Card {
  ...
  class GameOfWar {
    ...
    play(){
      ...
      if (this.p1.length > 0) {
        console.log(`Player 1 has won!!! They have ${this.p1.length} cards in their deck. P2 has ${this.p2.length}`)
      } else {
        console.log(`Player 2 has won!!! They have ${this.p2.length} cards in their deck. P1 has ${this.p1.length}`)
      }
    }
  }
